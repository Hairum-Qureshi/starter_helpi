				...
				messages: [
					{
						...
						content: `I am looking to generate a detailed and lengthy report catered towards helping a user find a list of 4 different careers by name that would closely match with what they've answered given a set of questions. Please titled it ${
							...
							api_request === "user_report"
								...
								: "Please only list the 4 careers by name and the percentage (that totals up to 100) of how likely the user fits for that specific career and nothing else. If the career's name length exceeds 28 characters, abbreviate it. Do not add any markdown and make sure none of the percentages are undefined."
